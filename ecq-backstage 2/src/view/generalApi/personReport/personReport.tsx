...
import GaugeStu from "@/components/echarts/GaugeStu";
                ...
                <div class="canvasBox">
                    <div class='canvastext text-xl pb-[10px] pl-[10px]' style={textStyle} >
                        ...
                        <div style={{ display: 'flex', color: store.echartsColor, marginTop: '2px' }} class='items-center'>
                            ...
                            {/* <div class='canvas_item'>积极性:{store.emoBar.positive ? store.emoBar.positive : '暂无评测数据'}</div> */}
                        </div>
                        ...
                        {/* 学习 */}
                        <div style={{ display: 'flex', color: store.echartsColor }} class='text-xl  my-1 mt-6 flex items-center'>
                            <span class='text-2xl font-bold'>▲学习状态</span>
                        </div>
                        {store.generalRow.gamesPoint.length == 2 
                        && <div style={{ display: 'flex', color: store.echartsColor, marginTop: '2px' }} class='items-center flex'>
                        ...
                        <div class='canvas_item text-2xl font-bold' style={learnColor.value} >
                            <span class='text-2xl font-bold'>综合得分:</span>{store.stuBar.stroop && store.stuBar.cognition ? store.stuBar.cognition + store.stuBar.stroop : 26}
                        </div>
                    ...
                    <div class='shell'>
                        ...
                        {
                            // 学习状态
                            store.generalRow.gamesPoint.length == 2 || store.generalRow.gamesPoint.length >= 2
                                ? <>
                                ...
                                : <>
                                    <div style='display:none'>
                                        {store.generalRow.gamesPoint.length = 0}
                                        {(store.generalRow.gamesPoint as unknown as Array<any>).push(...learnDefault)}
                                        {console.log(store.generalRow.gamesPoint, '我也不知道为啥这render function要这么写,但这么写准没bug')}
                                    </div>
                                    <div class='stateTostudy' style="height:80px;margin-top:0px;justify-content: flex-end;">
                                        {/* <LearnStateBar title='' /> */}
                                    </div>
                    ...
                    <div class='h-[200px] flex mt-[6px] w-full' >
                        {/* <MoodStateBar /> */}
                        <Gauge />
                        <GaugeStu />
                    ...
                    <div style={{ display: 'flex', color: store.echartsColor, marginTop: '12px' }}>
                        {appraiseText.value === '情绪状态良好'
                            ...
                            : appraiseText.value !== null
                                // 输出0,1,2
                                ? <div style={{ color: store.echartsColor, marginTop: '2px' }} class='text-2xl'>
