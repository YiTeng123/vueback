    ...
    <div class="cardContainer" :style="{ display: 'flex', color: store.echartsColor }">
        <el-card class="box-card" :body-style="{ backGround: 'red' }">
            ...
            <div class=" item personCard text-xl" :style="{ color: store.echartsColor }">
                <div class="personItem">学校:{{ }}</div>
                <div class="personItem">年级数:{{ }}</div>
                <div class="personItem">班级数:{{ }}</div>
                <div class="personItem">总人数:</div>
                <div class="personItem">需关注:</div>
                <!-- <div class="personItem">班级:(待补充)</div> -->

            </div>

            <div class="text item personCard" :style="{ color: store.echartsColor }">
